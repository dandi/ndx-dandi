# Next Steps for ndx-dandi Extension for NWB:N

## Creating Your Extension

1. In a terminal, change directory into the new ndx-dandi directory.
...
4. Modify `src/create_extension_spec.py` to define your extension.
    ...
    - If you want to create any custom classes for interacting with the extension,
      ...
      - If present, the `src/pynwb` folder MUST contain the following:
        - `ndx-dandi` - Folder with the sources of the NWB extension
        - `ndx-dandi/__init__.py` - Python file that may be empty
...
`spec/ndx-dandi.namespace.yaml` and
`spec/ndx-dandi.extensions.yaml` files.
...
2. Start a git repository for your extension directory ndx-dandi
...
8. Make a release for the extension on GitHub with the version number specified. e.g. if version is 0.1.0, then this page should exist: https://github.com/yarikoptic/ndx-dandi/releases/tag/0.1.0

9. Publish your updated extension on PyPi.
    - Follow these directions: https://packaging.python.org/tutorials/packaging-projects/
    - You may need to modify `setup.py`
    - If your extension version is 0.1.0, then this page should exist: https://pypi.org/project/ndx-dandi/0.1.0
...
`staged-extensions/ndx-dandi`:

    ```bash
cp -r staged-extensions/example staged-extensions/ndx-dandi
```

11. Edit `staged-extensions/ndx-dandi/ndx-meta.yaml`
...
name: ndx-dandi
version: 0.1.0
src: https://github.com/yarikoptic/ndx-dandi
pip: https://pypi.org/project/ndx-dandi/
license: BSD 3-Clause
maintainers:
  - yarikoptic
```

12. Edit `staged-extensions/ndx-dandi/README.md`
to add information about your extension. You may copy it from
`ndx-dandi/README.md`.

  ```bash
cp ndx-dandi/README.md staged-extensions/ndx-dandi/README.md
```
...
ndx-dandi-feedstock will be created in the nwb-extensions
GitHub organization and you will be added as a maintainer for that repository.


## Updating Your Published Extension

1. Update your ndx-dandi GitHub repository.

2. Publish your updated extension on PyPi.

3. Fork the ndx-dandi-feedstock repository on GitHub.
